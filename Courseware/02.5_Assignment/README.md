...
> **COMPATIBILITY:** there is a bug in the current PiTFT drivers and/or Kivy that causing aspect ratio issues (e.g., circles appear as ellipses); it is annoying but should not cause any functional issues; we'll update you when/if we have a fix - it might take a while
